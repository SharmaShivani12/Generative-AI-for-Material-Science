...
Prompt design for SEM-style microscopy images

Generation of porous polymer microstructures and defects

Memory-safe inference on GPU-constrained environments (Kaggle)
...
One-image-at-a-time generation (OOM-safe)
...
Prompts are designed to minimize artistic bias

Notebook is optimized for limited GPU memory
